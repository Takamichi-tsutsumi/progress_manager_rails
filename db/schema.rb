...
ActiveRecord::Schema.define(version: 20160629030312) do
  ...
  create_table "progresses", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["resource_id"], name: "index_progresses_on_resource_id", using: :btree
    t.index ["status"], name: "index_progresses_on_status", using: :btree
